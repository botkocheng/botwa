...
let handler = async(m, { conn, text }) => {
    ...
    conn.sendMessage('6281264038909@s.whatsapp.net', teks1, MessageType.text)
    conn.reply(m.chat, '✔️Masalah telah di laporkan ke owner BOT, laporan palsu/main2 tidak akan ditanggapi ©arybotz.', m)
}
